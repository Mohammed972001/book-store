      ...
      <div className="max-w-md w-full bg-gray-200 rounded-lg shadow-xl overflow-hidden relative z-10">
        <div className="p-6 sm:p-8">
          <div className="flex justify-center">
            <LuCheckCircle className="text-blue-500 w-16 h-16 mb-4" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold text-center text-blue-500 mb-2">
            Purchase Successful!
          </h1>
          ...
          <div className="bg-gray-300 rounded-lg p-4 mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-semibold text-blue-500">#2024</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            >
              <PiHandHeart className="mr-2" size={18} />
              Thanks for trusting us!
            </button>
            <Link
              to={"/"}
              className="w-full bg-gray-300 hover:bg-blue-300 hover:text-blue-700 text-blue-500 font-bold py-2 px-4 
            rounded-lg transition duration-300 flex items-center justify-center"
            >
              Continue Shopping
